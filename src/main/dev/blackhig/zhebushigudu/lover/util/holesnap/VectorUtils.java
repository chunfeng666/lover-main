...
public final class VectorUtils
{
    ...
    public final ArrayList<BlockPos> getBlockPosInSphere(final Vec3d center, final float radius) {
        ...
        int n = (int)intRange.getLeft();
        final int n2 = (int)intRange.getRight();
        if (n <= n2) {
            int x;
            do {
                x = n++;
                final Pair<Integer, Integer> intRange2 = this.getAxisRange(center.y, radius);
                int n3 = (int)intRange2.getLeft();
                final int n4;
                if (n3 > (n4 = (int)intRange2.getRight())) {
                    continue;
                }
                int y;
                do {
                    ...
                    int n5 = (int)intRange3.getLeft();
                    final int n6;
                    if (n5 > (n6 = (int)intRange3.getRight())) {
                        continue;
                    }
                    int z;
                    do {
    ...
    private final Pair<Integer, Integer> getAxisRange(final double d1, final float d2) {
        return (Pair<Integer, Integer>)new Pair((Object)(int)Math.floor(d1 - d2), (Object)(int)Math.ceil(d1 + d2));
    }
