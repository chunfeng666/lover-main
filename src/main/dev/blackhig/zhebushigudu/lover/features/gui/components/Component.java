...
public class Component extends Feature
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        lover.textManager.drawStringWithShadow(this.getName(), this.x + 3.0f, this.y - 4.0f - loverGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
        ...
        if (this.open) {
            ...
            if (ClickGui.getInstance().outline.getValue()) {
                ...
                GL11.glBegin(2);
                GL11.glColor4f(ClickGui.getInstance().o_red.getValue() / 255.0f, ClickGui.getInstance().o_green.getValue() / 255.0f, ClickGui.getInstance().o_blue.getValue() / 255.0f, ClickGui.getInstance().o_alpha.getValue() / 255.0f);
