...
public class AutoCityPlus extends Module
{
    ...
    private void surroundMine(final BlockPos position) {
        if (InstantMine.breakPos != null) {
            ...
            if (InstantMine.breakPos.equals((Object)new BlockPos(AutoCityPlus.target.posX, AutoCityPlus.target.posY, AutoCityPlus.target.posZ)) && AutoCityPlus.mc.world.getBlockState(new BlockPos(AutoCityPlus.target.posX, AutoCityPlus.target.posY, AutoCityPlus.target.posZ)).getBlock() != Blocks.AIR) {
                return;
            }
            if (InstantMine.breakPos.equals((Object)new BlockPos(AutoCityPlus.mc.player.posX, AutoCityPlus.mc.player.posY + 2.0, AutoCityPlus.mc.player.posZ))) {
                return;
            }
